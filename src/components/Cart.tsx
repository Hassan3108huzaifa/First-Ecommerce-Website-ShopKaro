...
const Cart: React.FC<CartProps> = ({ items, onCheckout }) => {
  ...
  const handleCheckout = () => {
    if (selectedItems.length === 0) {
      ...
      onCheckout(); // Trigger the parent component's checkout function
    }
  };
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/3 bg-gray-100 p-4 rounded-lg sticky top-4 h-fit">
        ...
        <button 
          onClick={handleCheckout} // Checkout now handled here
